        ...
        <div className="border-t border-slate-700 pt-6 text-center text-xs text-slate-500">
          <div className="mb-4">
            <a href="https://www.veteranownedbusiness.com" target="_blank" rel="noopener noreferrer">
              <img src="https://www.veteranownedbusiness.com/images/banner_links/SDVOSB-Member-Badge-Horizontal.jpg" alt="Veteran Owned Business Directory, Get your free listing, now!" width={200} height={60} style={{ maxWidth: '200px', height: 'auto' }} className="inline-block" />
            </a>
          </div>
