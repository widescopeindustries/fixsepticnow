...
export function StickyMobileCTA() {
  ...
  const smsHref = `sms:+14695066606?body=${smsBody}`;
  ...
  return (
    <div className="md:hidden fixed bottom-0 left-0 right-0 z-50 bg-green-700 border-t border-green-800 shadow-lg">
      <div className="grid grid-cols-3 divide-x divide-green-800">
        ...
        <a href={smsHref} aria-label="Text us for septic help" className="flex flex-col items-center gap-1 py-3 text-white hover:bg-green-800">
