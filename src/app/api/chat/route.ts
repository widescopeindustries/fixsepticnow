...
export async function POST(req: NextRequest) {
  try {
    ...
    if (!messages || messages.length > 20) {
      return NextResponse.json({ reply: "For faster help, please call us at (936) 297-7856." });
    }
    ...
    return NextResponse.json(
      { reply: "I'm having trouble right now. Please call (936) 297-7856 for immediate help." },
      { status: 500 }
    );
  }
}
