...
export async function POST(req: NextRequest) {
  try {
    ...
    if (!messages || messages.length > 20) {
      return NextResponse.json({ reply: "For faster help, please call us at (469) 986-7883." });
    }
    ...
    return NextResponse.json(
      { reply: "I'm having trouble right now. Please call (469) 986-7883 for immediate help." },
      { status: 500 }
    );
  }
}
