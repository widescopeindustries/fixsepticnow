...
const allFaqs = [
  ...
  { question: "How long does it take to get a permit for septic tank installation in Texas?", answer: "In Texas, obtaining an On-Site Sewage Facility (OSSF) installation permit typically takes 2 to 4 weeks. The timeline depends on your local county health department or TCEQ authorized agent, site evaluation, soil percolation testing, and engineering design approval." },
  { question: "Can you inspect your own septic system in Texas?", answer: "In Texas, homeowners of conventional gravity septic systems in certain counties can inspect their own systems after completing a basic homeowner maintenance course. However, aerobic treatment systems (ATUs) usually require a licensed OSSF maintenance provider contract per county regulations." },
];
