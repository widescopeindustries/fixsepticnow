...
function getServiceFaqs(serviceName: string, shortName: string, priceRange: string) {
  ...
  return [
    { question: `How much does ${serviceName.toLowerCase()} cost in Texas?`, answer: `${serviceName} in Texas typically costs ${priceRange}. Final pricing depends on tank size, accessibility, and property conditions. Call (936) 297-7856 for a free estimate.` },
    ...
    { question: `Is emergency ${serviceName.toLowerCase()} available?`, answer: `Yes. We provide 24/7 emergency ${sn} across Texas with same-day dispatch. Call (936) 297-7856 anytime — nights, weekends, and holidays included.` },
...
const serviceQuickAnswers: Record<string, { question: string; answer: string }> = {
  ...
  "emergency-septic-service": { question: "How quickly can I get emergency septic service in Texas?", answer: "We dispatch emergency septic technicians 24/7 across Texas with response times typically under 60 minutes. Stop using all water immediately and call (936) 297-7856 — every minute matters during a sewage backup." },
