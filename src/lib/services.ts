...
export const services: Service[] = [
  ...
  {
    name: "Emergency Septic Pumping",
    slug: "emergency-septic-service",
    shortName: "Emergency",
    description: "24/7 emergency septic pumping for backups, overflows, and sewage emergencies. Same-day response — we're there when you need us most.",
    icon: "Siren",
    keywords: ["emergency septic pumping", "emergency septic service", "24/7 septic pumping", "septic emergency", "sewage backup emergency"],
